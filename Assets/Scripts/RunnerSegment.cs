...
public class RunnerSegment 
{
    ...
    public Vector3 GetNextOrigin() { return origin + Vector3.right * segmentWidth * MainScript.brickWidth; }
    ...
    public RunnerSegment SetupSegment(int width,Vector3 ori)
    {
        ...
        CreateHouse(new Vector2Int(width / 2, 1), GetRandomIntBetween(7,15), GetRandomIntBetween(6,12));
